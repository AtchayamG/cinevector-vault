...
- **[0:45 - 1:30] Gemini 3.7 Flash Feature Extraction (Local Fixture)**: Show the web interface (`http://localhost:8001`). Select character Maya Vance. Demonstrate how the app extracts visual tokens (costume, lighting, facial traits) using dynamic local fixtures that simulate the Gemini 3.7 Flash contract.
